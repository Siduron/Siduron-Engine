...
#ifndef TOLUA_DISABLE_tolua_LuaInterface_Logger_Instance00
static int tolua_LuaInterface_Logger_Instance00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_LuaInterface_Logger_Log00
static int tolua_LuaInterface_Logger_Log00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaInterface_Logger_Progress00
static int tolua_LuaInterface_Logger_Progress00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
int tolua_LuaInterface_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"Logger");
  tolua_function(tolua_S,"Instance",tolua_LuaInterface_Logger_Instance00);
  tolua_function(tolua_S,"Log",tolua_LuaInterface_Logger_Log00);
  tolua_function(tolua_S,"Progress",tolua_LuaInterface_Logger_Progress00);
